...
public class SipStack extends Configure {
	...
	public final static  int heartBeatCircle = 30;
	 ...
	 */
	public static long retransmission_timeout = 1000;//500;//16000;//原值：2000 ====== 避免重复收到多条消息记录
	/**
	 * maximum retransmission timeout (milliseconds); called T2 in RFC2361; they
	 * suggest T2=4sec
	 */
	public static long max_retransmission_timeout = 4000;//32000;//原值：16000
	/** transaction timeout (milliseconds); RFC2361 suggests 64*T1=32000ms */
	public static long transaction_timeout = 8000;//32000;//128000;//8000 modify
	...
	//Add by zzhan 2013-04-28 modify by liangzhang 2014-08-28 修改不播放无人接听提示音的问题
	public static long invite_transaction_timeout = 200000/*32000*/;//modify by hu 32000
	 ...
	 * value.
	 */
	public static int default_expires = 1800;//60;//3600; //modify by 2014/2/12
	...
	private static void printLog(String str) {
		System.out.println("SipStack: "+"time="+ System.currentTimeMillis()+"..."+ str);
	}
}
