...
public interface Codec {
	...
	/**
	 *   add by  oumogang  2012 12 18 
	 * @param buffer
	 * @param lin
	 * @param payloadLength
	 * @param frames  how much frame to decode
	 * @return
	 */
	int decode(byte[] buffer, short[] lin, int payloadLength, int frames);
	/**
	 * @author zed
	 * @param checkInstance SlientCheck instance
	 * */
	void setVad(SlientCheck checkInstance);
}
