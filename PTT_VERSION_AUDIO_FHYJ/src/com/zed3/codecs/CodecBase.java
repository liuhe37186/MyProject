...
public class CodecBase implements Preference.OnPreferenceChangeListener {
	...
	public void setVad(SlientCheck checkInstance){
		this.slientCheck = checkInstance;
	}
