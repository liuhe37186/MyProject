...
#include <string.h>
#include <stdio.h>
#include "amr_svp/interf_enc.h"
#include "amr_svp/typedef.h"
//#include "amr_svp/sp_enc.h"
#include "amr_svp/com_zed3_codecs_AMR.h"
#include "amr_svp/gsmamr_encoder_wrapper.h"

#define LOG_TAG "amr-svp-jni-encode"
...
//	enum Mode req_mode = MR122;
	...
	jint encoded = Encoder_Interface_Encode(amr,mode, in1, out1, 0);
	LOGI("encoded len : %d\n", encoded);
