...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_oneTimeInitializationImpl(JNIEnv* env, jobject obj,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_createSocketImpl(JNIEnv* env, jclass clazz,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_createDatagramSocketImpl(JNIEnv* env, jclass clazz,
        jobject fileDescriptor, jboolean preferIPv4Stack) {
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_readSocketDirectImpl(JNIEnv* env, jclass clazz,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_readSocketImpl(JNIEnv* env, jclass clazz,
    ...
    result = Java_com_zed3_net_impl_OSNetworkSystem_readSocketDirectImpl(env, clazz, fileDescriptor,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_writeSocketDirectImpl(JNIEnv* env, jclass clazz,
        jobject fileDescriptor, jint address, jint offset, jint count) {
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_writeSocketImpl(JNIEnv* env, jclass clazz,
        jobject fileDescriptor, jbyteArray data, jint offset, jint count) {
...
#define INTERNAL_SEND_BUFFER_MAX 512
    ...
    result = Java_com_zed3_net_impl_OSNetworkSystem_writeSocketDirectImpl(env, clazz, fileDescriptor,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_setNonBlockingImpl(JNIEnv* env, jclass clazz,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_connectSocketImpl(JNIEnv* env, jclass clazz,
        jobject fileDescriptor, jint trafficClass, jobject inetAddr, jint port);

extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_connectWithTimeoutSocketImpl(JNIEnv* env,
    ...
    if (useAdbNetworking && !isLocalhost(&address)) {
        return Java_com_zed3_net_impl_OSNetworkSystem_connectSocketImpl(env, clazz, fileDescriptor,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_connectStreamWithTimeoutSocketImpl(JNIEnv* env,
    ...
    if (handle == 0 || handle == -1) {
        ...
        // Check if we're using adb networking and redirect in case it is used.
        if (useAdbNetworking && !isLocalhost(&address)) {
            int retVal = Java_com_zed3_net_impl_OSNetworkSystem_connectSocketImpl(env, clazz,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_connectSocketImpl(JNIEnv* env, jclass clazz,
    ...
    if (useAdbNetworking && !isLocalhost(&address)) {
        ...
        Java_com_zed3_net_impl_OSNetworkSystem_connectStreamWithTimeoutSocketImpl(env, clazz,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_socketBindImpl(JNIEnv* env, jclass clazz,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_listenStreamSocketImpl(JNIEnv* env, jclass clazz,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_availableStreamImpl(JNIEnv* env, jclass clazz,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_acceptSocketImpl(JNIEnv* env, jclass clazz,
...
extern "C" jboolean Java_com_zed3_net_impl_OSNetworkSystem_supportsUrgentDataImpl(JNIEnv* env,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_sendUrgentDataImpl(JNIEnv* env, jclass clazz,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_connectDatagramImpl2(JNIEnv* env, jclass clazz,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_disconnectDatagramImpl(JNIEnv* env, jclass clazz,
        jobject fd) {
...
extern "C" jboolean Java_com_zed3_net_impl_OSNetworkSystem_socketBindImpl2(JNIEnv* env, jclass clazz,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_peekDatagramImpl(JNIEnv* env, jclass clazz,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_receiveDatagramDirectImpl(JNIEnv* env, jclass clazz,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_receiveDatagramImpl(JNIEnv* env, jclass clazz,
    ...
    int actualLength = Java_com_zed3_net_impl_OSNetworkSystem_receiveDatagramDirectImpl(env, clazz, fd,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_recvConnectedDatagramDirectImpl(JNIEnv* env,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_recvConnectedDatagramImpl(JNIEnv* env, jclass clazz,
        jobject fd, jobject packet, jbyteArray data, jint offset, jint length,
        jint receiveTimeout, jboolean peek) {
    ...
    int actualLength = Java_com_zed3_net_impl_OSNetworkSystem_recvConnectedDatagramDirectImpl(env,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_sendDatagramDirectImpl(JNIEnv* env, jclass clazz,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_sendDatagramImpl(JNIEnv* env, jclass clazz,
        jobject fd, jbyteArray data, jint offset, jint length, jint port,
        jboolean bindToDevice, jint trafficClass, jobject inetAddress) {
    // LOGD("ENTER sendDatagramImpl");

    jbyte *bytes = env->GetByteArrayElements(data, NULL);
    int actualLength = Java_com_zed3_net_impl_OSNetworkSystem_sendDatagramDirectImpl(env, clazz, fd,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_sendConnectedDatagramDirectImpl(JNIEnv* env,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_sendConnectedDatagramImpl(JNIEnv* env, jclass clazz,
        jobject fd, jbyteArray data, jint offset, jint length,
        jboolean bindToDevice) {
    // LOGD("ENTER sendConnectedDatagramImpl");

    jbyte *bytes = env->GetByteArrayElements(data, NULL);
    int actualLength = Java_com_zed3_net_impl_OSNetworkSystem_sendConnectedDatagramDirectImpl(env,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_createServerStreamSocketImpl(JNIEnv* env,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_createMulticastSocketImpl(JNIEnv* env,
        jclass clazz, jobject fileDescriptor, jboolean preferIPv4Stack) {
 ...
 */
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_receiveStreamImpl(JNIEnv* env, jclass clazz,
        jobject fileDescriptor, jbyteArray data, jint offset, jint count,
        jint timeout) {
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_sendStreamImpl(JNIEnv* env, jclass clazz,
        jobject fileDescriptor, jbyteArray data, jint offset, jint count) {
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_shutdownInputImpl(JNIEnv* env, jobject obj,
        jobject fileDescriptor) {
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_shutdownOutputImpl(JNIEnv* env, jobject obj,
        jobject fileDescriptor) {
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_sendDatagramImpl2(JNIEnv* env, jclass clazz,
        jobject fd, jbyteArray data, jint offset, jint length, jint port,
        jobject inetAddress) {
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_selectImpl(JNIEnv* env, jclass clazz,
...
extern "C" jobject Java_com_zed3_net_impl_OSNetworkSystem_getSocketLocalAddressImpl(JNIEnv* env,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_getSocketLocalPortImpl(JNIEnv* env, jclass clazz,
...
extern "C" jobject Java_com_zed3_net_impl_OSNetworkSystem_getSocketOptionImpl(JNIEnv* env, jclass clazz,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_setSocketOptionImpl(JNIEnv* env, jclass clazz,
...
extern "C" jint Java_com_zed3_net_impl_OSNetworkSystem_getSocketFlagsImpl(JNIEnv* env, jclass clazz) {
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_socketCloseImpl(JNIEnv* env, jclass clazz,
        jobject fileDescriptor) {
...
extern "C" jobject Java_com_zed3_net_impl_OSNetworkSystem_getHostByAddrImpl(JNIEnv* env, jclass clazz,
        jbyteArray addrStr) {
...
extern "C" jobject Java_com_zed3_net_impl_OSNetworkSystem_getHostByNameImpl(JNIEnv* env, jclass clazz,
...
extern "C" void Java_com_zed3_net_impl_OSNetworkSystem_setInetAddressImpl(JNIEnv* env, jobject obj,
...
/*
extern "C" jobject Java_com_zed3_net_impl_OSNetworkSystem_inheritedChannelImpl(JNIEnv* env, jobject obj) {
