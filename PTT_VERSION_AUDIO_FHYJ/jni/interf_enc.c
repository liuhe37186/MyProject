   ...
   *stream = toc_byte[mode];
   ...
   if ( mode == 15 ) {
      ...
      if ( frame_type == TX_SID_UPDATE ){
    	  LOGI("if( frame_type == TX_SID_UPDATE )");
         *stream += 0x01;
      }
      *stream <<= 3;
   ...
   if (noHoming){
      ...
      switch ( mode ) {
         case MR122:
            homing = dhf_MR122;
            homing_size = 18;
            LOGI("mode = MR122,homing_size = %d\n", 18);
            break;

         case MR102:
            homing = dhf_MR102;
            homing_size = 12;
            LOGI("mode = MR102,homing_size = %d\n", 12);
            break;

         case MR795:
            homing = dhf_MR795;
            homing_size = 8;
            LOGI("mode = MR795,homing_size = %d\n", 8);
            break;

         case MR74:
            homing = dhf_MR74;
            homing_size = 7;
            LOGI("mode = MR74,homing_size = %d\n", 7);
            break;

         case MR67:
            homing = dhf_MR67;
            homing_size = 7;
            LOGI("mode = MR67,homing_size = %d\n", 7);
            break;

         case MR59:
            homing = dhf_MR59;
            homing_size = 7;
            LOGI("mode = MR59,homing_size = %d\n", 7);
            break;

         case MR515:
            homing = dhf_MR515;
            homing_size = 7;
            LOGI("mode = MR515,homing_size = %d\n", 7);
            break;

         case MR475:
            homing = dhf_MR475;
            homing_size = 7;
            LOGI("mode = MR475,homing_size = %d\n", 7);
            break;

         default:
            homing = NULL;
            homing_size = 0;
            LOGI("mode = default,homing_size = %d\n", 0);
            break;
      }
