...
const char *kInterfacePath = "com/zed3/pjlib/gsm";

gsm0610_state_t *gsm0610_enc_state;
gsm0610_state_t *gsm0610_dec_state;

extern "C"
JNIEXPORT jint JNICALL Java_com_zed3_codecs_GSM_open
...
extern "C"
JNIEXPORT jint JNICALL Java_com_zed3_codecs_GSM_encode
...
extern "C"
JNIEXPORT jint JNICALL Java_com_zed3_codecs_GSM_decode
    (JNIEnv *env, jobject obj, jbyteArray encoded, jshortArray lin, jint size) {

	//Modify by zzhan 2012-12-17  max ptime is 200ms
	//jshort post_amp[BLOCK_LEN];
	//jbyte gsm0610_data[BLOCK_LEN];
	jshort post_amp[BLOCK_LEN * 10];
	jbyte gsm0610_data[BLOCK_LEN * 10];
...
extern "C"
JNIEXPORT void JNICALL Java_com_zed3_codecs_GSM_close
    (JNIEnv *env, jobject obj) {
